...
<div class="d-flex  flex-column flex-md-row align-items-center p-3 px-md-4 mb-3   top-block border-bottom shadow-sm">
  <h5 class="my-0 mr-md-auto font-weight-normal">Cooking teacher</h5>
  <nav class="my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" href="{{route('homepage')}}">Главная</a>
    <a class="p-2 text-dark" href="{{route('contact')}}">Контакты</a>
    <a class="p-2 text-dark" href="{{route('feedback')}}">Обратная связь</a>
